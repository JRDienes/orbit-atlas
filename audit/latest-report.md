...
|---|---|---|---|
| First Contentful Paint (FCP) | 0.4 s | Good ✅ |  ↑53ms slower |
| Largest Contentful Paint (LCP) | 1.7 s | Needs Improvement ⚠️ |  ↑145ms slower |
| Total Blocking Time (TBT) | 1,210 ms | Poor ❌ |  ↓2507ms faster |
| Cumulative Layout Shift (CLS) | 0.003 | Good ✅ |  → |
| Speed Index | 9.2 s | Poor ❌ | |
| Time to Interactive (TTI) | 28.3 s | Poor ❌ |  ↑655ms slower |
...
| Metric | Value |
|---|---|
| JS Execution Time | 1.4 s |
| Main Thread Work | 42.6 s |
| DOM Size | N/A |
| Total Page Weight | Total size was 2,091 KiB |
| Network Requests | 71 |
...
Total Blocking Time is 1,210 ms. Break large `postMessage` payloads from the satellite worker into smaller chunks so the main thread is never blocked > 50 ms.
