...
|---|---|---|---|
| First Contentful Paint (FCP) | 0.3 s | Good ✅ |  ↓72ms faster |
| Largest Contentful Paint (LCP) | 0.9 s | Good ✅ |  ↑109ms slower |
| Total Blocking Time (TBT) | 4,070 ms | Poor ❌ |  ↓572ms faster |
| Cumulative Layout Shift (CLS) | 0.004 | Good ✅ |  → |
| Speed Index | 9.3 s | Poor ❌ | |
| Time to Interactive (TTI) | 27.9 s | Poor ❌ |  ↓349ms faster |
...
Total Blocking Time is 4,070 ms. Break large `postMessage` payloads from the satellite worker into smaller chunks so the main thread is never blocked > 50 ms.
